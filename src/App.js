...
const [text, setText] = useState("")
  ...
  return (
    <div>
      ...
      <div className='cover'>
        <h1>Welcome to KARIMFLIX</h1>
        <img alt="cover" src='https://www.breakflip-awe.com/uploads2/Thomas/2021/Juillet/the-tomorrow-war-netflix-france.jpg' />
      </div>
     

      <Routes>
        <Route path="/" element={ <MovieList setMovies={setMovies} text={text} movies={movies}/>
} />
